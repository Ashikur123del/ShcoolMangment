...
import { Search, Menu, Sun, Moon, User, Settings, LogOut, ChevronDown } from 'lucide-react';
  ...
  return (
    <nav className="h-20 bg-white/80 dark:bg-[#0f111a]/80 backdrop-blur-md border-b border-gray-100 dark:border-white/5 flex items-center justify-between px-6 sticky top-0 z-40 transition-all duration-300">
      <div className="flex items-center gap-4">
        {/* মোবাইল এবং ডেস্কটপ মেনু বাটন */}
        <button 
          onClick={() => setSidebarOpen(!sidebarOpen)} 
          className="p-2.5 text-gray-500 dark:text-gray-400 hover:bg-[#ffa001]/10 hover:text-[#ffa001] rounded-xl transition-all active:scale-95"
        >
          <Menu size={22} />
        </button>
